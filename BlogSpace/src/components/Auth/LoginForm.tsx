      ...
      <div className="max-w-md w-full space-y-8">
        <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-md rounded-xl sm:rounded-2xl shadow-xl p-6 sm:p-8 border border-gray-200 dark:border-gray-700">
          ...
          <div className="mb-4 sm:mb-6">
            <div className="bg-blue-50 dark:bg-blue-900/50 border border-blue-200 dark:border-blue-800 rounded-lg p-3 sm:p-4">
              <h3 className="font-semibold text-blue-900 dark:text-blue-100 mb-2 text-sm sm:text-base">Demo Accounts:</h3>
              <div className="text-xs sm:text-sm text-blue-800 dark:text-blue-200 space-y-1">
                <div><strong>Admin:</strong> admin@blog.com / password</div>
                <div><strong>User:</strong> user@blog.com / password</div>
              </div>
            </div>
          </div>
